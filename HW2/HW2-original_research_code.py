...
mseed_files = sorted(glob.glob(f'{MSEED_DIR}event*_ssls_timeframe.mseed'), key=extract_evt_num)
...
for mseed in mseed_files:
        ...
        try:
            ...
            tmpl_i, RMS_p, pe, fc, fd, fsd = compute_metrics(st_inf, process_taper=True, metric_taper=None, filter_band=FILT_INF,
                                                window_length=DR_WIN_LEN, overlap=0.8,
                                                vlatlon=VLATLON)
            ...
            timestamps = [st_inf[0].stats.starttime.datetime + timedelta(days=(t-start_day)) for t in tmpl_i_1D]
...
evt_times = [
    {"event": 1, "start": '2023-7-14T05:31:41', "end": '2023-7-14T11:25:12'},
    {"event": 2, "start": '2023-7-16T00:08:05', "end": '2023-7-16T07:20:13'},
    {"event": 3, "start": '2023-7-18T09:17:02', "end": '2023-7-18T16:50:43'},
    {"event": 4, "start": '2023-7-22T13:17:10', "end": '2023-7-23T08:32:53'},
    {"event": 5, "start": '2023-7-26T09:26:45', "end": '2023-7-26T19:10:00'},
    {"event": 6, "start": '2023-8-04T01:24:52', "end": '2023-8-04T16:35:32'},
    {"event": 8, "start": '2023-8-25T13:00:49', "end": '2023-8-26T02:17:26'},
    {"event": 10, "start": '2023-9-15T23:04:00', "end": '2023-9-16T05:28:59'},
    {"event": 11, "start": '2023-9-24T20:38:31', "end": '2023-9-25T14:30:38'},
    {"event": 12, "start": '2023-10-03T03:36:54', "end": '2023-10-03T16:22:25'},
    {"event": 13, "start": '2023-11-03T02:57:09', "end": '2023-11-03T15:02:08'},
]
